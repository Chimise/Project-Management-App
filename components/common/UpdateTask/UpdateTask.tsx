  ...
  return (
    <form onSubmit={handleSubmit} className="mt-1">
      <div className="flex space-x-6 items-center">
        ...
        <DeleteButton
          onConfirm={() =>
            removeTask({ taskId: task.id, projectId: project.id })
          }
        />
      </div>
      ...
      <div className="mt-2">
        ...
        <CommentList
          ...
          onAddFavorite={favoriteCommentHandler}
      ...
      <div className="flex justify-end mt-5">
        <button
          ...
          className={cn(
            "px-3 py-2 rounded-lg transition-all duration-300 font-medium shadow-sm uppercase focus:outline-none hover:shadow-md",
            {
